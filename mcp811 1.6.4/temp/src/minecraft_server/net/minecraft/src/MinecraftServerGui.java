...
import net.minecraft.src.MinecraftServerGuiINNER1;
import net.minecraft.src.MinecraftServerGuiINNER2;
import net.minecraft.src.MinecraftServerGuiINNER3;
import net.minecraft.src.PlayerListComponent;
import net.minecraft.src.StatsComponent;
import net.minecraft.src.TextAreaLogHandler;
