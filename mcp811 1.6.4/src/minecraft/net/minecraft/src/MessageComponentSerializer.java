            ...
            if (var17 != null)
            {
                if (var17.isJsonArray())
                {
                    ...
                    while (var19.hasNext())
                    {
                        ...
                        {
                            var20.add(this.deserializeComponent(var16, par2Type, par3JsonDeserializationContext));
                        }
                    }

                    var4.addFormatted(var7.getAsString(), var20.toArray());
                }
                else if (var17.isJsonPrimitive())
                {
                    var4.addFormatted(var7.getAsString(), new Object[] {var17.getAsString()});
                }
            }
            else
            {
